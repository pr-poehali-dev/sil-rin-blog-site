...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-sky-50 via-white to-blue-50 py-20 lg:py-32">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Творческий дуэт{" "}
            <span className="font-medium text-sky-600">Сили</span> и{" "}
            <span className="font-medium text-sky-600">Ринни</span> — авторы
            книг, мечтающие о комиксах и историях в мире Minecraft
          </p>

          {/* Current Focus */}
          <div className="inline-flex items-center bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 mb-12 border border-sky-100">
            <Icon name="BookOpen" size={20} className="text-sky-600 mr-2" />
      ...
      <div className="absolute top-10 left-10 opacity-20">
        <Icon name="Sparkles" size={24} className="text-sky-300" />
      </div>
